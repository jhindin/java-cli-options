...
public class Main {
	...
	{
		CliOptions cliOptions = new CliOptions("ab:c#dh", Arrays.asList("aaa", "bbb:", "ccc#", "ddd", "help"));
	...
	static void usage()
	{
		System.err.println("arguments : <|-adh]> [<-b arg>] [<-c arg>*] [--aaa] [--bbb arg] [-ccc arg] [-ddd] [--help]");
	}
